...
public class MyWebSocketMessage {
  ...
  private static final Set<String> VALID_CLIENT_TYPES = Set.of(
    TYPE_CLIENT_CREATE_ROOM, TYPE_CLIENT_JOIN_ROOM, TYPE_CLIENT_LEAVE_ROOM, TYPE_CLIENT_PLAYER_MESSAGE, TYPE_SYSTEM
  );

  private static final Set<String> VALID_SERVER_TYPES = Set.of(
    TYPE_SERVER_ROOM_CREATED, TYPE_SERVER_ROOM_JOINED, TYPE_SERVER_ROOM_LEFT, TYPE_SERVER_CHAT_MESSAGE, TYPE_SERVER_ROOM_STATE, TYPE_SERVER_GAME_STATE
  );
